 ...
 * lab-specific — the schema is the single source of truth.
 */
    ...
    <Panel title="PARAMETERS" className="sb-params" flush>
      <div className="sb-params__body">
        ...
        {specs.map((spec) => {
          ...
          const isLocked = locked.has(spec.key);
          const isDefault = value === spec.default;
          const isBlended = blendedKeys.includes(spec.key);
          return (
            <div key={spec.key} className="sb-params__row" title={spec.hint}>
